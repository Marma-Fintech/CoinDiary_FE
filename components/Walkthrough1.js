  ...
  return (
    ...
    >
      ...
      <span className={`flex w-full flex-col mt-16 px-9 ${textColorClass}`}>
        ...
        <div className="justify-center items-stretch flex w-[55px] max-w-full gap-3.5 mt-16 self-start">
          <img
            loading="lazy"
        ...
        <div
          className={`bg-rose-600 self-stretch flex flex-col justify-center items-stretch mt-8 p-px rounded ${buttonColorClass}`}
        >
        ...
        <div
          className={`text-neutral-500  text-center text-sm mr-5 leading-5 self-center whitespace-nowrap mt-4 ${skipColorClass}`}
        >
