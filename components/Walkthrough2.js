  ...
  return (
    ...
    >
      ...
      <span className={`flex w-full flex-col mt-16 px-9 ${textColorClass}`}>
        ...
        >
          <div className="z-[1] flex flex-col justify-center items-center px-15 py-3.5  rounded">
        ...
        <div
          className={`text-neutral-500  text-center text-sm mr-5 mb-3 leading-5 self-center whitespace-nowrap mt-4 ${skipColorClass}`}
        >
